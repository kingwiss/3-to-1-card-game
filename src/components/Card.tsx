...
const Card: React.FC<CardProps> = ({ card, onClick, onGambleChoice, isPlayable = false, isHidden = false, isDisabled = false, themeColor = 'teal-gray' }) => {
